      ...
      <div className="grid grid-cols-4 gap-3 mb-4">
        ...
        <div className="stat-card" style={{ borderLeftColor: '#2563eb' }}>
          <div>
            ...
            <Link href="/students" style={{ color: '#2563eb', fontSize: '0.85rem', display: 'inline-flex', alignItems: 'center', gap: '4px', marginTop: '0.5rem', fontWeight: '500' }}>
        ...
        <div className="stat-card" style={{ borderLeftColor: '#f97316' }}>
          <div>
            ...
            <Link href="/guardians" style={{ color: '#f97316', fontSize: '0.85rem', display: 'inline-flex', alignItems: 'center', gap: '4px', marginTop: '0.5rem', fontWeight: '500' }}>
