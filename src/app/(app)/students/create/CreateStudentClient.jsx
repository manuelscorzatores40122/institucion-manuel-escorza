    ...
    <div className="card" style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="celular">Cell/Emergencia</label>
            <input type="text" className="form-control" id="celular" name="celular" value={formData.celular || ''} onChange={handleInputChange} placeholder="Ej. 987654321" />
          </div>
          ...
          <div className="form-group" style={{ gridColumn: 'span 2' }}>
            ...
            <select className="form-control" name="vive_con" value={formData.vive_con || ''} onChange={handleInputChange}>
              <option value="">-- Seleccionar --</option>
          ...
          <div className="form-group" style={{ gridColumn: 'span 2', marginTop: '1.5rem' }}>
            <h4 style={{ color: 'var(--primary)', borderBottom: '2px solid var(--border-color)', paddingBottom: '0.5rem' }}><i className='bx bx-user-pin'></i> Datos de otro Apoderado (Opcional - Si es distinto)</h4>
          </div>

          <div className="form-group">
            <label className="form-label" htmlFor="apoderado_alterno_dni">DNI Apoderado</label>
            <input type="text" className="form-control" id="apoderado_alterno_dni" name="apoderado_alterno_dni" value={formData.apoderado_alterno_dni || ''} onChange={handleInputChange} />
          </div>

          <div className="form-group">
            <label className="form-label" htmlFor="apoderado_alterno_celular">Celular Apoderado</label>
            <input type="text" className="form-control" id="apoderado_alterno_celular" name="apoderado_alterno_celular" value={formData.apoderado_alterno_celular || ''} onChange={handleInputChange} />
          </div>
