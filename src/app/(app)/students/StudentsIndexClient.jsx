        ...
        <div style={{ marginTop: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div className="d-flex gap-1" style={{ display: 'flex', gap: '4px' }}>
            {(() => {
              ...
              const lastPage = studentsData.last_page || 1;
              let pages = [];
              if (lastPage <= 7) {
                ...
                <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                  ...
                  {pages.map((p, idx) => (
                    <button 
                      ...
                      style={{
                        background: p === currentPage ? 'linear-gradient(135deg, #2563eb, #3b82f6)' : p === '...' ? 'transparent' : 'white',
                        ...
                        boxShadow: p === currentPage ? '0 4px 10px -2px rgba(59, 130, 246, 0.5)' : 'none',
                        transition: 'all 0.2s',
